...
def database_management():
    ...
    choose = option_menu(
        ...
        "nav-link": {"font-family":"Roboto","font-size": "22px", "text-align": "left", "margin":"0px", "--hover-color": "#eee"},
...
def about():
    ...
    st.write("This project is to demonstrate the power of Snowflake Native Apps. The objective of this project is to develop an App that provides GUI-based governance features for managing the Snowflake environment. Some of the features could be")
def Menu_navigator():
