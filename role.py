...
def monitor3(tab_id):
  ...
  with col_proj:
    ...
    st.write(constructed_query)  # Temporarily print the constructed SQL query
    subject_areas = ['All'] + [result[0].strip() for result in execute_query(conn, constructed_query)]
